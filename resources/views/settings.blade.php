                ...
                <div class="mt-20 md:mt-6 mx-auto w-full md:w-2/3 lg:w-1/3">
                    <form action="" method="POST" class="flex flex-col gap-4" enctype="multipart/form-data">
                        ...
                        <div class="mt-6 flex flex-col gap-4">
                            <h1 class="text-lg font-semibold">Đổi mật khẩu</h1>
                        ...
                        <button type="submit" class="mt-6 bg-[#222831] text-white rounded-3xl px-4 py-2 font-semibold w-full text-sm lg:text-base">Lưu thay đổi</button>
                    </form>
                </div>
